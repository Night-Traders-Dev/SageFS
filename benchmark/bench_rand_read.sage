## bench_rand_read.sage — Random read benchmark via VFS
...
proc main():
    ...
    let dev: String = "/tmp/sagefs_bench_rr.img"
    format_image(dev)
    ...
    i = 0
    while i < blocks:
        let off: Int = ((i * 19) % blocks) * block_size
        fs.lseek(fd2, off, vfs.SEEK_SET)
    ...
    if elapsed_ms <= 0:
        ...
        print "  randread: " + str(kb_per_s) + " KB/s"
